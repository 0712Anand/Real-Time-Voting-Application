...
BASE_URL = 'https://randomuser.me/api/?nat=ap'
PARTIES = ["Tech Republic Party","Management Party","Saviour Party"]
...
def delivery_report(err,msg):
    if err is not None:
        ...
        print(f"Succesful delivery to {msg.topic()} [{msg.partition()}] ")
